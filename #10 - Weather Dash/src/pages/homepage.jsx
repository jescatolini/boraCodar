      ...
      <div className={styles.container}>
        <div className={styles.containerCards}>
          <div style={{ alignSelf: "flex-start" }}>
            <img src={weatherIcon} className={styles.weather} alt="weather" />
          </div>
          <DegreeCard
            actualTemperature={
              weather
            ...
            maxTemperature={
              weather
                ? `${parseInt(weather?.daily?.temperature_2m_max[0])}${
                    weather?.daily_units?.temperature_2m_max
                  }`
                : ""
            }
          ...
          <div className={styles.rightSide}>  
            <div className={styles.airAndSun}>
              <AirCard
                ...
                nitrogen={airQuality?.hourly?.nitrogen_dioxide[0] || ""}
                ozone={airQuality?.hourly?.ozone[0] || ""}
                pm2_5={airQuality?.hourly?.pm2_5[0] || ""}
                pm10={airQuality?.hourly?.pm10[0] || ""}
                sulphur={airQuality?.hourly?.sulphur_dioxide[0] || ""}
                europeanEvaluation={airQuality?.hourly?.european_aqi[0] || ""}
              />
              <SunHour
            ...
            <WeekWeather
              minWeeklyTemperature={weather?.daily?.temperature_2m_min}
              maxWeeklyTemperature={weather?.daily?.temperature_2m_max}
            />
          </div>
        </div>
      </div>
